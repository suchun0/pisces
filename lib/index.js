...
Pisces.prototype._animate = function _animate (coords, options) {
  ...
  var step = function (timestamp) {
    ...
    var x = coords.start.x + coords.end.x * progress;
    var y = coords.start.y + coords.end.y * progress;
...
Pisces.prototype._setScroll = function _setScroll (x, y) {
    if ( x === void 0 ) x = 0;
    if ( y === void 0 ) y = 0;

  var ref = this;
    var scrollingBox = ref.scrollingBox;
  var currentScrollTop = scrollingBox.scrollTop;
    var currentScrollLeft = scrollingBox.scrollLeft;
